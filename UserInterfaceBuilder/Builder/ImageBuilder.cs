...
namespace XamarinFormsStarterKit.UserInterfaceBuilder
{
    public static class ImageBuilder
    {
        ...
        public static string HorizontalStripes = ResourceLoader.GetEmbeddedResourceString("HorizontalStripes.svg");



        public static string GreenStripes = ResourceLoader.GetEmbeddedResourceString("GreenStripes.svg");



        public static string Honeycomb = ResourceLoader.GetEmbeddedResourceString("Honeycomb.svg");



        public static string Chevrons = ResourceLoader.GetEmbeddedResourceString("Chevrons.svg");

        public static string CarbonFiber = ResourceLoader.GetEmbeddedResourceString("CarbonFiber.svg");



        public static string MicrobialMat = ResourceLoader.GetEmbeddedResourceString("MicrobialMat.svg");



        public static string Dance = ResourceLoader.GetEmbeddedResourceString("Dance.svg");



        public static string Checkerboard = ResourceLoader.GetEmbeddedResourceString("Checkerboard.svg");



        public static string Waves = ResourceLoader.GetEmbeddedResourceString("Waves.svg");



        public static string VerticalStripes = ResourceLoader.GetEmbeddedResourceString("VerticalStripes.svg");



        public static string Shippo = ResourceLoader.GetEmbeddedResourceString("Shippo.svg");



        public static string HalfRombes = ResourceLoader.GetEmbeddedResourceString("HalfRombes.svg");



        public static string Transparent = ResourceLoader.GetEmbeddedResourceString("Transparent.svg");



        public static string SimpleHorizontal = ResourceLoader.GetEmbeddedResourceString("SimpleHorizontal.svg");



        public static string WhiteCarbon = ResourceLoader.GetEmbeddedResourceString("WhiteCarbon.svg");



        public static string CrossStripes = ResourceLoader.GetEmbeddedResourceString("CrossStripes.svg");



        public static string SubtleDots = ResourceLoader.GetEmbeddedResourceString("SubtleDots.svg");



        public static string ThinStripes = ResourceLoader.GetEmbeddedResourceString("ThinStripes.svg");



        public static string SpeckledNoise = ResourceLoader.GetEmbeddedResourceString("SpeckledNoise.svg");



        public static string BlueprintGrid = ResourceLoader.GetEmbeddedResourceString("BlueprintGrid.svg");



        public static string Argyle = ResourceLoader.GetEmbeddedResourceString("Argyle.svg");
