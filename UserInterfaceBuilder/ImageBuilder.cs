...
namespace XamarinFormsStarterKit.UserInterfaceBuilder
{
    public static class ImageBuilder
    {
        ...
        public static void LoadImage(Layout layout, bool apply = true, bool suppressBackGroundColor = true)
        {
            if (!apply)
            {
                return;
            ...
            foreach (var child in layout.Children)
            {
                ...
                {
                    double height, width;
                    FinalizeDimensions(currentControl, img, out height, out width);
        ...
        private static void FinalizeDimensions(VisualElement currentControl, SvgCachedImage img, out double height, out double width)
        {
