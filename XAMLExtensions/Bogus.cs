...
public static readonly DataSet DataSet = new DataSet(Locale);
	...
	public static readonly Bogus.DataSets.Database Database = new Bogus.DataSets.Database(Locale);
	public static readonly Date Date = new Date(Locale);
	public static readonly Finance Finance = new Finance(Locale);
	...
	public static readonly Rant Rant = new Rant(Locale);
	public static readonly System System = new System(Locale);
	...
	public static T PickRandom<T>() => Faker.PickRandom();
	public static T PickRandomWithout<T>(T[] exclude) => Faker.PickRandomWithout(exclude);
	...
	public static string CountryCode(Bogus.DataSets.Iso3166Format format) => Address.CountryCode(format);
	...
	public static System.DateTime Past(int yearsToGoBack, DateTime? refDate) => Date.Past(yearsToGoBack, refDate);
	public static System.DateTime Soon(int days) => Date.Soon(days);
	public static System.DateTime Future(int yearsToGoForward, DateTime? refDate) => Date.Future(yearsToGoForward, refDate);
	public static System.DateTime Between(System.DateTime start, System.DateTime end) => Date.Between(start, end);
	public static System.DateTime Recent(int days) => Date.Recent(days);
	public static System.TimeSpan Timespan(TimeSpan? maxSpan) => Date.Timespan(maxSpan);
	...
	public static Bogus.DataSets.Currency Currency(System.Boolean includeFundCodes) => Finance.Currency(includeFundCodes);
	...
	public static System.Version Version() => System.Version();
	public static System.Exception Exception() => System.Exception();
